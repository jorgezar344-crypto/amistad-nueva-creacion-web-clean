...
export const HomeHeroWithHeart: React.FC<HomeHeroWithHeartProps> = ({
  ...
  return (
    <section
      id="inicio"
      className="relative min-h-[94vh] flex items-center justify-center px-4 sm:px-6 lg:px-12 pt-28 pb-20 overflow-hidden bg-void"
    ...
    >
      ...
      <div className="absolute inset-0 -z-30 overflow-hidden">
        <Image
          ...
          fill
          className="object-cover object-[center_42%] opacity-80 scale-100 transition-transform duration-1000"
          priority
        />
        {/* Filmic Directional Gradient: 85% Dark on Left -> 35-50% in Center -> Transparent on Right */}
        <div className="absolute inset-0 bg-gradient-to-r from-void via-void/75 to-transparent"></div>
        <div className="absolute inset-0 bg-gradient-to-t from-void via-transparent to-void/50"></div>
        {/* Amber Stage Warmth Accent + Subtle Cyan Ambient Spill */}
        <div className="absolute top-1/4 left-1/3 w-[500px] h-[500px] bg-amber-500/10 rounded-full blur-[140px] pointer-events-none"></div>
        <div className="absolute top-1/3 right-1/4 w-[600px] h-[600px] bg-cyan-electric/15 rounded-full blur-[160px] pointer-events-none"></div>
      </div>
      ...
      <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center z-20 pointer-events-none">
        <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left pt-2 lg:pt-0 pointer-events-auto">
          {/* Location Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-panel text-xs sm:text-sm font-semibold text-cyan-electric mb-6 shadow-cyanGlow border border-cyan-electric/30">
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-xs sm:text-sm font-bold tracking-[0.25em] uppercase text-cyan-electric drop-shadow-sm">
          ...
          {/* Pastoral Subtitle */}
          <p className="max-w-lg text-base sm:text-lg md:text-xl text-slate-200 leading-relaxed mb-8 font-normal drop-shadow-md">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto mb-8">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 rounded-full font-extrabold text-sm sm:text-base bg-cyan-electric text-void hover:bg-white hover:shadow-cyanGlowLg transition-all duration-300 transform active:scale-95 focus-visible:ring-2 focus-visible:ring-white flex items-center justify-center gap-2 shadow-cyanGlow"
            >
            ...
            <a
              ...
              className="w-full sm:w-auto px-8 py-4 rounded-full font-bold text-sm sm:text-base glass-panel text-white hover:border-cyan-electric hover:text-cyan-electric transition-all duration-300 flex items-center justify-center gap-2 focus-visible:ring-2 focus-visible:ring-cyan-electric"
            >
              <span>Conócenos</span>
            </a>
          </div>
          ...
          <a
            href="#mensajes"
            className="inline-flex items-center gap-2 text-xs sm:text-sm text-slate-300 hover:text-cyan-electric transition-colors bg-void/80 px-4 py-2 rounded-full border border-white/10 backdrop-blur-sm shadow-sm"
          >
