...
export const FirstVisitSection: React.FC<FirstVisitSectionProps> = ({ onOpenVisitModal }) => {
  ...
  return (
    <section
      id="primera-visita"
      className="relative py-20 sm:py-28 px-4 sm:px-6 lg:px-8 bg-void border-y border-cyan-electric/10 overflow-hidden"
      aria-label="Información para la primera visita"
    >
      {/* Ambient background glows */}
      <div className="absolute top-1/4 left-0 w-[500px] h-[500px] bg-cyan-electric/5 rounded-full blur-[160px] pointer-events-none -z-10" />
      <div className="absolute bottom-10 right-0 w-[450px] h-[450px] bg-amber-500/5 rounded-full blur-[140px] pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Dual Photographic Composition & 4-Pillars Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center mb-12 lg:mb-16">
          ...
          {/* Right Column: 4 Numbered Pillars in Glass Cards */}
